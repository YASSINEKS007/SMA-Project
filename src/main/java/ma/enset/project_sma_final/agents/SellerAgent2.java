...
public class SellerAgent2 extends GuiAgent {

    protected SellerContainer2 sellerContainer;
    String choosenPrice;

    @Override
    protected void setup() {
        if (getArguments().length == 1) {
            sellerContainer = (SellerContainer2) getArguments()[0];
            sellerContainer.sellerAgent2 = this;
        }
