...
public class SellerContainer2 extends Application {

    protected SellerAgent2 sellerAgent2;
    ...
    public void start(Stage stage) throws Exception {
        startContainer();
        stage.setTitle("Seller 2 Container");
    ...
    private void startContainer() {
        ...
        try {
            ...
            AgentController sellerController = container.createNewAgent("Seller-2",
                    SellerAgent2.class.getName(),
                    new Object[]{this});
    ...
    public void logMessagesPrice(String price) {
        Platform.runLater(() -> {
            observableListData.add("the proposed price for Seller 2 is : " + price);
